...
let data = [{
  cat: 'library', name: 'PedroMorais', value: 1000,
  icon: 'img/pedrom_nice.png',
  desc: `Eu sou um Polymath => Always Looking For Knowledge And New Challenges ▪
	Self-taught And Self-motivated Web Designer & Developer ▪
	
	Qualified Computer Technician For All Type Of Maintenance And Repair Equipment, Networks, Computer Systems ▪
	
	High Capacity For Analysis, Adaptation And Problem Solving ▪
	Able To Teamwork Or Lead Team ▪
	Responsible, Organized And Confident`
}, {
  cat: 'library', name: 'D3', value: 80,
  icon: 'img/d3.svg',
  desc: `
...
// 	icon: '',
// },{
  cat: 'framework', name: 'Bootstrap CSS', value: 80,
...
// }, {
  ...
  desc: `
	...
	cat: 'framework', name: 'Svelte', value: 40,
	icon: 'img/svelte.png',
	desc: `
...
// }, {
  ...
  desc: `
				...
				I use the one come with Google Chrome to debug our apps. It is one the the most powerful
...
// 			`
// }, {
  cat: 'tooling', name: 'Visual Studio Code', value: 80,
  icon: 'img/vscode.png',
  desc: `
...
// }, {
  ...
  cat: 'platform', name: 'Docker Platform', value: 30,
  icon: 'img/docker.svg',
  desc: `
...
// }, {
  ...
  cat: 'platform', name: 'WordPress', value: 80,
  icon: 'img/wp.png',
  desc: `
				WordPress is a content management system (CMS) based on PHP & MySQL. Used by more than 60 million websites
			`
}, {
  cat: 'language', name: 'HTML5 & CSS3', value: 100,
  icon: 'img/html5-css3.png',
  desc: `
				The languages of the Web Front End. we then we can build
				world-class websites with any kind of visual effects or designs requested.
			`
}, {
  cat: 'language', name: 'JavaScript', value: 150,
